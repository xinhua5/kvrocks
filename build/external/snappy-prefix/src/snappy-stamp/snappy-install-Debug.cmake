...
set(stdout_log "/root/kvrocks/build/external/snappy-prefix/src/snappy-stamp/snappy-install-out.log")
set(stderr_log "/root/kvrocks/build/external/snappy-prefix/src/snappy-stamp/snappy-install-err.log")
execute_process(
  COMMAND ${command}
...
if(result)
  ...
  if (${log_merged})
    ...
    set(msg "${msg}\nSee also\n  /root/kvrocks/build/external/snappy-prefix/src/snappy-stamp/snappy-install-*.log")
  endif()
  ...
  if(NOT "Ninja" MATCHES "Ninja")
    set(msg "snappy install command succeeded.  See also /root/kvrocks/build/external/snappy-prefix/src/snappy-stamp/snappy-install-*.log")
    message(STATUS "${msg}")
  endif()
endif()
