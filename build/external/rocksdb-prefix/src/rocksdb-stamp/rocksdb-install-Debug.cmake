...
set(stdout_log "/root/kvrocks/build/external/rocksdb-prefix/src/rocksdb-stamp/rocksdb-install-out.log")
set(stderr_log "/root/kvrocks/build/external/rocksdb-prefix/src/rocksdb-stamp/rocksdb-install-err.log")
execute_process(
  COMMAND ${command}
...
if(result)
  ...
  if (${log_merged})
    ...
    set(msg "${msg}\nSee also\n  /root/kvrocks/build/external/rocksdb-prefix/src/rocksdb-stamp/rocksdb-install-*.log")
  endif()
  ...
  if(NOT "Ninja" MATCHES "Ninja")
    set(msg "rocksdb install command succeeded.  See also /root/kvrocks/build/external/rocksdb-prefix/src/rocksdb-stamp/rocksdb-install-*.log")
    message(STATUS "${msg}")
  endif()
endif()
