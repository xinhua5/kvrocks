...
set(command "autoconf")
set(log_merged "")
set(log_output_on_failure "")
set(stdout_log "/root/kvrocks/build/external/jemalloc-prefix/src/jemalloc-stamp/jemalloc-autoconf-out.log")
set(stderr_log "/root/kvrocks/build/external/jemalloc-prefix/src/jemalloc-stamp/jemalloc-autoconf-err.log")
execute_process(
  COMMAND ${command}
...
if(result)
  ...
  if (${log_merged})
    ...
    set(msg "${msg}\nSee also\n  /root/kvrocks/build/external/jemalloc-prefix/src/jemalloc-stamp/jemalloc-autoconf-*.log")
  endif()
  ...
  if(NOT "Ninja" MATCHES "Ninja")
    set(msg "jemalloc autoconf command succeeded.  See also /root/kvrocks/build/external/jemalloc-prefix/src/jemalloc-stamp/jemalloc-autoconf-*.log")
    message(STATUS "${msg}")
  endif()
endif()
