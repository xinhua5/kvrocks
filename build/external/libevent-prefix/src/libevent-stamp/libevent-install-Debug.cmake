...
set(stdout_log "/root/kvrocks/build/external/libevent-prefix/src/libevent-stamp/libevent-install-out.log")
set(stderr_log "/root/kvrocks/build/external/libevent-prefix/src/libevent-stamp/libevent-install-err.log")
execute_process(
  COMMAND ${command}
...
if(result)
  ...
  if (${log_merged})
    ...
    set(msg "${msg}\nSee also\n  /root/kvrocks/build/external/libevent-prefix/src/libevent-stamp/libevent-install-*.log")
  endif()
  ...
  if(NOT "Ninja" MATCHES "Ninja")
    set(msg "libevent install command succeeded.  See also /root/kvrocks/build/external/libevent-prefix/src/libevent-stamp/libevent-install-*.log")
    message(STATUS "${msg}")
  endif()
endif()
