...
set(stdout_log "/root/kvrocks/build/external/glog-prefix/src/glog-stamp/glog-install-out.log")
set(stderr_log "/root/kvrocks/build/external/glog-prefix/src/glog-stamp/glog-install-err.log")
execute_process(
  COMMAND ${command}
...
if(result)
  ...
  if (${log_merged})
    ...
    set(msg "${msg}\nSee also\n  /root/kvrocks/build/external/glog-prefix/src/glog-stamp/glog-install-*.log")
  endif()
  ...
  if(NOT "Ninja" MATCHES "Ninja")
    set(msg "glog install command succeeded.  See also /root/kvrocks/build/external/glog-prefix/src/glog-stamp/glog-install-*.log")
    message(STATUS "${msg}")
  endif()
endif()
